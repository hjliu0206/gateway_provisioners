...
class ServerListener:
    ...
    def return_connection_info(self, com_port) -> None:
        ...
        self.prepare_comm_socket(com_port)  # self.comm_socket initialized
    ...
    def process_requests(self, com_port) -> None:
        ...
        self.return_connection_info(com_port)
...
def setup_server_listener(
    ...
    com_port = sl.build_connection_file()

    set_start_method("fork")
    # server_listener = Process(target=sl.process_requests)
    server_listener = Process(target=sl.process_requests, args=(com_port,))
